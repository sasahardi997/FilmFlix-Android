package com.example.filmflix.data;
        ...
        public List<Movie> getAllFavorite() {
            ...
            if (cursor.moveToFirst()) {
                do {
                    ...
                    movie.setVoteAverage((float) Double.parseDouble(cursor.getString(cursor.getColumnIndex(FavoriteContract.FavoriteEntry.COLUMN_USERRATING))));
